...
function videolife_notice() {
    ...
    echo '<div class="notice notice-success is-dismissible"><p>'. esc_html('Thank you for installing the VideoLife theme!','videolife') . '</p><p><a class="button-secondary" href="' . esc_url( $theme->get( 'ThemeURI' ) ) . '" target="_blank">' . esc_html( 'Theme Demo', 'videolife' ) . '</a> '. '&nbsp;' . ' <a class="button-primary" href="' . esc_url( $theme->get( 'AuthorURI' ) . '/themes/videolife-pro' ) . '" target="_blank">' . esc_html( 'Upgrade to PRO theme', 'videolife' ) . '</a></p></div>';
